...
//               Do you handle more than just music?
//             </AccordionTrigger>
//             <AccordionContent className="text-gray-400 text-base md:text-lg pb-4">
//               Yes. We provide full AV and lighting support for corporate events,
//               including microphones, screens, speakers, and staging.
//             </AccordionContent>
//           </AccordionItem>

//           <AccordionItem value="item-2" className="border-b border-[#161d2c]">
//             <AccordionTrigger className="flex justify-between items-center text-lg md:text-xl font-medium text-gray-300 py-4 hover:text-white transition-colors cursor-pointer hover:no-underline">
//               Can you support a multi-speaker conference or panel?
//             </AccordionTrigger>
//             <AccordionContent className="text-gray-400 text-base md:text-lg pb-4">
//               Absolutely. We regularly provide sound and technical support for
//               presentations, speakers, and breakout sessions.
//             </AccordionContent>
//           </AccordionItem>

//           <AccordionItem value="item-3" className="border-b border-[#161d2c]">
//             <AccordionTrigger className="flex justify-between items-center text-lg md:text-xl font-medium text-gray-300 py-4 hover:text-white transition-colors cursor-pointer hover:no-underline">
//               Do you coordinate with other vendors or teams?
//             </AccordionTrigger>
//             <AccordionContent className="text-gray-400 text-base md:text-lg pb-4">
//               Yes, we collaborate closely with your planning team, A/V partners,
//               or event producers to deliver a seamless experience.
//             </AccordionContent>
//           </AccordionItem>
//         </Accordion>
//       </div>
...
const CorporateFaq = () => {
  return (
    <div className="w-full max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-0">
      {/* Hero Section */}
      <div className="flex flex-col md:flex-row items-center md:items-start gap-10 lg:gap-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col space-y-6 text-center md:text-left">
          <div className="text-2xl sm:text-3xl md:text-[35px] md:leading-[45.5px] font-heading font-medium text-[#E9E9E7] space-y-2">
            <h1>
              <span className="bg-gradient-to-r from-[#4f46e5] to-[#7450f5] bg-clip-text text-transparent">
                You’ve
              </span>{" "}
      ...
      <div className="mt-12 sm:mt-16 w-full">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem
            ...
            className="border-b border-t border-[#161d2c]"
          >
            <AccordionTrigger className="flex justify-between items-center text-base sm:text-lg md:text-xl font-medium text-gray-300 py-4 hover:text-white transition-colors cursor-pointer hover:no-underline">
              Do you handle more than just music?
            </AccordionTrigger>
            <AccordionContent className="text-gray-400 text-sm sm:text-base md:text-lg pb-4">
              Yes. We provide full AV and lighting support for corporate events,
              including microphones, screens, speakers, and staging.
            </AccordionContent>
          </AccordionItem>
